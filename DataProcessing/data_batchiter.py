...
from DataProcessing.Dataloader import batch_data_variable
from Units.units import find_maxlen, find_maxlennum, find_char_maxlen
from data.buildBatch import buildBatch, padding_key


def create_tra_batch(tra_data, tag_vocab, batch_size, config, tokenizer, shuffle=False):
    ...
    for batch in unit:
        one_word_data = pair_word_data_variable(batch, tag_vocab, tokenizer, config)
